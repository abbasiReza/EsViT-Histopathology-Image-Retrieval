...
def get_args_parser():
    ...
    # Misc
    parser.add_argument('--data_path', default='/content/drive/MyDrive/dataSets/CRC/forDINO/train/', type=str,
        help='Please specify path to the ImageNet training data.')
    
    parser.add_argument('--pretrained_weights_ckpt', default='/content/drive/MyDrive/models/esvit-main/pretrained/checkpoint.pth', type=str, help="Path to pretrained weights to evaluate.")
